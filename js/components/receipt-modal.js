            ...
            <div id="${this.modalId}" class="receipt-modal">
                ...
                <div class="receipt-modal-content">
                    <div class="receipt-modal-header">
                        <h2 data-i18n="finance.receiptDetails">Детали чека</h2>
                    ...
                    <div class="receipt-modal-body">
                        <div class="receipt-info">
                            <div class="receipt-info-row">
                                <span class="receipt-info-label">🏪 <span data-i18n="finance.store">Магазин</span>:</span>
                                <span class="receipt-info-value" id="receipt-store"></span>
                            </div>
                            <div class="receipt-info-row">
                                <span class="receipt-info-label">📅 <span data-i18n="finance.date">Дата</span>:</span>
                                <span class="receipt-info-value" id="receipt-date"></span>
                            </div>
                            <div class="receipt-info-row">
                                <span class="receipt-info-label">💳 <span data-i18n="finance.paymentMethod">Оплата</span>:</span>
                                <span class="receipt-info-value" id="receipt-payment"></span>
                            </div>
                            <div class="receipt-info-row">
                                <span class="receipt-info-label">🧾 <span data-i18n="finance.invoiceNumber">Номер</span>:</span>
                                <span class="receipt-info-value" id="receipt-invoice"></span>
                            </div>
                        </div>

                        <div class="receipt-items-header">
                            <h3 data-i18n="finance.items">Товары</h3>
                        ...
                        <div class="receipt-total">
                            <span data-i18n="finance.total">Итого</span>:
